...
<head>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruangmezzanine.jpg'); /* Gambar diubah */
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruangmezzanine.jpg" alt="Ruang Mezzanine">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang Satgas tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
                ...
                <div class="info-box"><span>Kapasitas</span><strong>25 Orang</strong></div>
            </div>
            <div class="facility-section">
                <h3>Fasilitas Ruang Satgas</h3>
