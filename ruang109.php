...
<head>
    ...
    <title>Detail Ruang 109 Enjiniring</title>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruang109.jpg'); /* Gambar diubah */
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruang109.jpg" alt="Ruang 109 Enjiniring">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang 109 Enjiniring tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
            ...
            <div class="facility-section">
                <h3>Fasilitas Ruang 109 Enjiniring</h3>
