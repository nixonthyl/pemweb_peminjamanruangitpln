...
<head>
    ...
    <title>Detail Ruang 104 Batam</title>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruangbatam.jpg'); /* Gambar diubah */
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruangbatam.jpg" alt="Ruang 104 Batam">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang 104 Batam tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
            ...
            <div class="facility-section">
                <h3>Fasilitas Ruang 104 Batam</h3>
