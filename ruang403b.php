...
<head>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruang4b.jpg'); /* Gambar diubah */
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruang4b.jpg" alt="Ruang 403B">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang 403B tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
