...
<head>
    ...
    <title>Detail Ruang 103 PLN Indonesia Power</title>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruang pembangkit.jpg'); /* Gambar diubah */
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruang pembangkit.jpg" alt="Ruang Pembangkit">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang Pembangkit tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
                <div class="info-box"><span>Kategori</span><strong>Studio</strong></div>
                <div class="info-box"><span>Gedung</span><strong>A ITPLN</strong></div>
                <div class="info-box"><span>Lantai</span><strong>2</strong></div>
                <div class="info-box"><span>Kapasitas</span><strong>120 Orang</strong></div>
            </div>
            <div class="facility-section">
                <h3>Fasilitas Ruang Pembangkit</h3>
                <div class="facilities-grid">
                    <div class="facility-item"><i class="fas fa-desktop"></i><span>Layar Videotron</span></div>
