...
<head>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruangsatgas.jpg'); /* Gambar diubah */
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruangsatgas.jpg" alt="Ruang Satgas">
            </div>
            </div>
        <div class="room-details-panel">
            ...
            <div class="info-grid">
                ...
                <div class="info-box"><span>Kapasitas</span><strong>15 Orang</strong></div>
            </div>
            <div class="facility-section">
                ...
                <div class="facilities-grid">
                    ...
                    <div class="facility-item"><i class="fas fa-water"></i><span>Dispenser</span></div>
                </div>
            </div>
        </div>
    </div>
