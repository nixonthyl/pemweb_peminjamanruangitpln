...
<head>
    ...
    <title>Detail Ruang 110 Pelayaran Bahtera Adhiguna</title>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruang110.jpg'); /* Gambar diubah */
...
<body>
    ...
    <div class="detail-header">
        <h1>Ruang 110 Pelayaran Bahtera Adhiguna</h1>
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruang110.jpg" alt="Ruang 110 Pelayaran Bahtera Adhiguna">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang 110 Pelayaran Bahtera Adhiguna tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
            ...
            <div class="facility-section">
                <h3>Fasilitas Ruang 110 Pelayaran Bahtera Adhiguna</h3>
                <div class="facilities-grid">
                    <div class="facility-item"><i class="fas fa-tv"></i><span>Smart TV</span></div>
                    ...
                    <div class="facility-item"><i class="fas fa-wifi"></i><span>Wi-Fi</span></div>
                </div>
            </div>
        </div>
    </div>
