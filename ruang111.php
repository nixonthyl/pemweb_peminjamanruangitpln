...
<head>
    ...
    <title>Detail Ruang 111 Gas & Geothermal</title>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruang gas geo.jpg'); /* Gambar diubah */
...
<body>
    ...
    <div class="detail-header">
        <h1>Ruang 111 Gas & Geothermal</h1>
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruang gas geo.jpg" alt="Ruang 111 Gas & Geothermal">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang 111 Gas & Geothermal tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
            ...
            <div class="facility-section">
                <h3>Fasilitas Ruang 111 Gas & Geothermal</h3>
