...
<head>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruang404.jpg'); /* Gambar diubah */
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruang404.jpg" alt="Ruang 403B">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang 404B tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
                <div class="info-box"><span>Kategori</span><strong>Ruang Kelas</strong></div>
                <div class="info-box"><span>Gedung</span><strong>B ITPLN</strong></div>
                <div class="info-box"><span>Lantai</span><strong>4</strong></div>
                <div class="info-box"><span>Kapasitas</span><strong>40 Orang</strong></div>
            </div>
            <div class="facility-section">
                <h3>Fasilitas Ruang 404B</h3>
