...
<head>
    ...
    <style>
        ...
        .detail-header {
            padding: 40px 5%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('gambar/ruang np.jpg'); /* Gambar diubah */
...
<body>
    ...
    <div class="detail-header">
        <h1>Ruang 108 PLN Nusantara Power</h1>
    ...
    <div class="detail-container">
        <div class="image-gallery">
            <div class="main-image">
                <img id="main-room-image" src="gambar/ruang np.jpg" alt="Ruang 108 PLN Nusantara Power">
            </div>
            </div>
        <div class="room-details-panel">
            <div class="status-box">
                Ruang 108 PLN Nusantara Power tersedia, belum ada yang meminjam.
            </div>
            <div class="info-grid">
            ...
            <div class="facility-section">
                <h3>Fasilitas Ruang 108 PLN Nusantara Power</h3>
